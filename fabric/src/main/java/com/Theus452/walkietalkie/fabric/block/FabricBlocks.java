...
public class FabricBlocks {
    public static void register() {
        ...
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(WalkieTalkieMod.MOD_ID, "walkie_talkie_block"), walkieBlock);
        ...
        Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, new ResourceLocation(WalkieTalkieMod.MOD_ID, "walkie_talkie_block_entity"), beType);
