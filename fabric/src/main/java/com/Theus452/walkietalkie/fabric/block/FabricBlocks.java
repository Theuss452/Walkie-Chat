...
public class FabricBlocks {
    public static void register() {
        ...
        Registry.register(Registry.BLOCK, new ResourceLocation(WalkieTalkieMod.MOD_ID, "walkie_talkie_block"), walkieBlock);
        ...
        Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(WalkieTalkieMod.MOD_ID, "walkie_talkie_block_entity"), beType);
